   ...
   <title>Cinemata</title>
	...
	<body>
		...
		<?php
			...
			$Card_number = $Cvv = $Fname = $Lname = $exp_date = "";
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST") {
				...
				$payment = "INSERT INTO PAYMENT (Fname, Lname, Card_number, Cvv, exp_date) 
							VALUES ('$Fname', '$Lname', '$Card_number', '$Cvv', '$exp_date')";
		...
		?>
			...
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="payment">
				...
				<input type="text" name="Fname" maxlength="20" placeholder="First Name" required class="number">
				<input type="text" name="Lname" maxlength="20" placeholder="Last Name" required class="number">
				<input type="text" name="exp_date" maxlength="5" placeholder="01/21" required class="number">
				<br><br>
